  ...
  data() {
    return {
      ...
      programs: [
        ...
        { cat:'council', title: 'ミュージカル「シンデレラ」', at: 'X棟n階', by: 'ESS', src: '/images/prg/unknown.png', desc: '皆さんは観たくなる魔法にかかりましたか？誰も想像し得ない新感覚（多分）のMusical Cinderellaの開演です！Let’s get loud！✨✨' },
