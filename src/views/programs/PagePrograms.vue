  ...
  <div class="programs">
    <v-container class="my-5">
      ...
      <v-row dense>
        ...
        <v-col cols="6" xs="6" sm="4" md="3" lg="3" xl="3">
          <v-card>
            <v-img src="/images/prg/radio.png" class="white--text align-end" height="auto"></v-img>
            <v-card-actions class="mx-n2">
              <v-expansion-panels flat accordion>
                <v-expansion-panel>
...
export default {
  data() {
    return {
      show: false,
      programs: [
        { cat:'homeroom', title: 'スポーツワールド', at: 'X棟n階', by: '2年生', src: '/images/prg/unknown.png', desc: '世界のスポーツの中で気軽に楽しめるもの２つを、コロナ禍の旅行へ行きにくい今だからこそ体験してもらいたいと思います。がんばったら景品もあるかも？ぜひ来てください！' },
        { cat:'homeroom', title: '迷Q', at: 'X棟n階', by: '2年生', src: '/images/prg/meiq.png', desc: '世界に関するクイズを解きながら迷路を抜ける、迷路とクイズを融合した企画　　　　　あなたは薄暗い迷宮に迷い込んでしまった。あなたの目の前にあるのは世界に関する2択の問題たち。この問題は一定時間すると変わるらしい。あなたはクイズに正解し、この迷宮を抜け出せるだろうか。' },
        ...
        { cat:'homeroom', title: '縁日Fes', at: 'X棟n階', by: '4年生', src: '/images/prg/ennichifes.jpg', desc: 'スーパーボールすくいや射的などの屋台を出します。縁日で遊びたい人いたら、いつでも中庭にお越しください！射的でもスーパーボールでも何でもありますよ景品も御座います！とにかく中庭にお越しください！' },
        ...
        { cat:'homeroom', title: 'The Escape', at: 'X棟n階', by: '5年生', src: '/images/prg/theescape.png', desc: 'お化け屋敷と謎解きゲームの融合。ようこそ滅亡した世界へ。あなたは自然を失ったこの地球に一人きり。彼女からのメッセージを頼りに様々な謎を解き、脱出用ロケットへたどり着け。想像を超える謎やからくりに挑め。愛を忘れるな。' },
        ...
        { cat:'homeroom', title: '大型制作', at: 'X棟n階', by: '6年生', src: '/images/prg/works.png', desc: '約50人で大規模製作に取り組みました！製作物は3つあり、チームラボ、つまようじアートに加え、9回生学年企画劇の舞台装置製作にも携わっています。個性豊かな製作物、ぜひ楽しんでください。' },
        { cat:'homeroom', title: '映像制作', at: 'X棟n階', by: '6年生', src: '/images/prg/unknown.png', desc: '準備中' },
        { cat:'council', title: 'ミュージカル「シンデレラ」', at: 'X棟n階', by: 'ESSパフォーマンス部', src: '/images/prg/essperformance.jpg', desc: '皆さんは観たくなる魔法にかかりましたか？誰も想像し得ない新感覚（多分）のMusical Cinderellaの開演です！Let’s get loud！✨✨' },
        { cat:'council', title: '公開ディベート', at: 'X棟n階', by: 'ESSディベート部', src: '/images/prg/essdebate.jpg', desc: '今年も公開英語ディベートを行います！個性豊かな部員たちが全国レベルのスピーチを披露してくれます。国語や社会でやった人もいるディベートが「競技」になるとどうなるのか...？結果を是非確かめに来てください！' },
        ...
        { cat:'council', title: '魚・製作物展示・実験', at: 'X棟n階', by: '科学研究部', src: '/images/prg/science.jpg', desc: '科学研究部では、魚や部員が製作したものを展示しています。また、エッグドロップチャレンジを行うこともできます。実験を行っているかもしれません。是非来てみて下さい。' },
        { cat:'council', title: '合格おみくじ・恋みくじ', at: 'X棟n階', by: '男子バスケットボール部', src: '/images/prg/basketball.jpg', desc: '男子篭球部は普通の御籤だけではなく，大学受験，中学受験を占う合格御籤，恋愛経験豊富な我々のアドバイス付き恋御籤などを販売します．一回100円．割と豪華な景品あり．' },
        { cat:'council', title: 'ギネス世界記録にチャレンジ！', at: 'X棟n階', by: '男子テニス部', src: '/images/prg/stage.png', desc: '男子テニス部のとある部員がギネス世界記録に本気で挑戦します。この日のために汗水たらしてトレーニングを積んできました。本気で本気の彼の下剋上をご覧ください。' },
        { cat:'council', title: 'クッキー販売', at: '中庭', by: '家庭科研究部', src: '/images/prg/kateken.jpg', desc: '伝統の味、家庭科研究部のクッキーを販売しています！味はプレーン、チョコチップ、抹茶、紅茶の4種類！是非お買い求め下さい✨' },
        { cat:'council', title: 'フードドライブと食のクイズ', at: 'X棟n階', by: 'ESD foodプロジェクト', src: '/images/prg/esdfood.png', desc: '家に無駄になっている食品はありませんか?ESDフードプロジェクトでは今年度もフードドライブを行います!クイズも用意していますので、是非色々な食品を持ってきて下さい!' },
        ...
        { cat:'council', title: '缶バッジ作りワークショップ・部員作品展示', at: 'X棟n階', by: '美術部', src: '/images/prg/art.jpg', desc: 'びーっ、びじゅつぶ！げんきげんき！（某教育テレビのマラカス付き妖精風）　毎年大盛況の缶バッジ作りワークショップ、今年も開催します！部員を唸らせる作品を作った方には何かいいことがあるかも！？' },
        ...
        { cat:'council', title: '学校グッズ販売', at: 'X棟n階', by: '生徒会執行部', src: '/images/prg/goods.png', desc: 'こんにちは！生徒会執行部です。中庭のアリーナ前で学校グッズを販売しています！ぜひお立ち寄りください！' },
        { cat:'team', title: '先生とプレバト!!', at: 'X棟n階', by: '有志+国語の先生', src: '/images/prg/haiku.png', desc: '俳句の査定でお馴染みの才能査定ランキングが兎原祭にやってきます！見事才能アリに輝くのは誰だ！？' },
        { cat:'team', title: '有志アニメーション', at: 'X棟n階', by: '10回生有志', src: '/images/prg/animation.png', desc: '「悪霊退散!」でお馴染みの陰陽師、実は現代技術を駆使する者だった!?この世界に隔たりなんて存在しない。奇想天外な「歴史×テクノロジー」堂々登場！' },
        { cat:'team', title: 'calm with heat(バンド)', at: '音楽室', by: '吹奏楽部・コーラス部有志', src: '/images/prg/musicroom.png', desc: '私達5人は吹奏楽部とコーラス部で構成されています！音楽を知り、音楽が好きな私達だからこその力のある演奏をします！みんなが一度は聞いたことのある曲をするのでぜひ聴きに来てください！' },
        { cat:'team', title: 'Leo(バンド)', at: '音楽室', by: '10回生有志', src: '/images/prg/musicroom.png', desc: '私達は、10回生4人で構成されているバンドです！メンバーのボーカル兼エレキ、アコギ、キーボード、そして盛り上げ隊長(？)は、それぞれそれなりに個性的なメンバーです！バンドの名前は、8月の星座の名前から取りました。バンドを結成したのが丁度去年の8月だったからです。そんな私達が、約半年間かけて練習してきた数曲を、全力で演奏します！' },
        { cat:'team', title: 'anima(バンド)', at: '音楽室', by: '9回生有志', src: '/images/prg/musicroom.png', desc: 'こんにちは！私たちはanimaです。曲ごとによってメンバーが変わって出演するので、どの曲を誰がするかは当日のお楽しみ！最高に楽しいステージを届けるので一緒に盛り上がりましょう！' },       
        { cat:'team', title: 'うなぎパイ補完計画(バンド)', at: '音楽室', by: '11回生有志', src: '/images/prg/musicroom.png', desc: 'うなぎパイ補完計画（仮）です。ノリと勢いだけで集まった６人組がアニメ曲を演奏します。サックスが入っていたりキーボードが二人だったり摩訶不思議なバンドですがぜひ聞きに来てください' },
        ...
        { cat:'team', title: 'AsRicotta(ダンス)', at: 'ステージ', by: '11～13回生有志', src: '/images/prg/stage.png', desc: '私たちアスリコットは11回生から13回生までのメンバーでダンスパフォーマンスをします！学年をまたいでのパフォーマンスも！？来たらあなたも盛り上がること間違いなし！ぜひ見に来てください！' },
        { cat:'teacher', title: '入学適性検査相談コーナー', at: 'X棟n階', by: '入学適性検査推進室', src: '/images/prg/council.png', desc: '適性検査相談会を実施します。' },
        { cat:'teacher', title: '家庭科教科展示', at: 'X棟n階', by: '家庭科', src: '/images/prg/council.png', desc: '生徒の日々の努力をご覧ください。' },
      ],
    };
  },
  computed: {
