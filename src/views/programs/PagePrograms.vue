  ...
  data() {
    return {
      ...
      programs: [
        ...
        { cat:'team', title: 'PIBARA(バンド)', at: '音楽室', by: '11回生有志', src: '/images/prg/unknown.png', desc: '私たちPIBARAです！11回生5人で構成されたバンドグループです。未経験者もいる中、約1ヶ月間の練習で頑張って仕上げました！みんなが知ってる有名なあの曲も！？是非音楽室を覗いてみて下さい！！' },
        { cat:'team', title: 'AsRicotta(ダンス)', at: 'X棟n階', by: '11～13回生有志', src: '/images/prg/unknown.png', desc: '私たちアスリコットは11回生から13回生までのメンバーでダンスパフォーマンスをします！学年をまたいでのパフォーマンスも！？来たらあなたも盛り上がること間違いなし！ぜひ見に来てください！' },
