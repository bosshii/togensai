<template>
  <div class="access">
    <v-container class="my-5">
      ...
      ご予約の際には、<router-link :to=" { name: 'privacy' } ">プライバシーポリシー</router-link>もご確認ください。<br><br><div class="text-h5">2日目定員到達しました。沢山のご予約ありがとうございました。</div><br>※キャンセルが出ると予約できますので随時ご確認ください。<br>
      <br><br>
